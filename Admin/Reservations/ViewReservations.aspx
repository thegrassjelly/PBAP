                ...
                <div class="col-lg-12">
                    <div class="panel panel-midnightblue">
                                    ...
                                    <asp:ListView ID="lvReservations" runat="server"
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><span class='<%# Eval("ReservationStatus").ToString() == "Pending" ? "label label-danger" : "label label-success"%>'>
                                                    <%# Eval("ReservationStatus") %>
                                                                                    </span></td>
                                                <td><span class='<%# Eval("PaymentStatus").ToString() == "Unpaid" ? "label label-danger" : "label label-success"%>'>
                                                    <%# Eval("PaymentStatus") %>
                                                                                    </span></td>
                        ...
                        <div class="panel-footer">
                            <center>
                                        <asp:DataPager id="dpReservations" runat="server" pageSize="10" PagedControlID="lvReservations">
                                            <Fields>
